...
export default {
  ...
  computed: {
    connectEndpoint() {
      return `https://auth-dev.vatsim.net/oauth/authorize?client_id=482&redirect_uri=http://dev.czqm.ca/auth&response_type=code&scope=full_name+email+vatsim_details+country`;
    },
  },
  setup: async () => {
