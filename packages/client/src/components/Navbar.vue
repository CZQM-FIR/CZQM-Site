...
export default {
  ...
  computed: {
    connectEndpoint() {
      return `https://auth.vatsim.net/oauth/authorize?client_id=316&redirect_uri=http://localhost:3000/auth&response_type=code&scope=full_name+email+vatsim_details+country`;
    },
  },
  setup: async () => {
