      ...
      <div class="info-wrapper content text-formatting">
        <div class="info-card controller-card">
          ...
          >
            <div class="controller-info">
              <span class="controller-callsign"
                >{{ controller.callsign }} ({{ controller.frequency }})</span
              >
              <span
              ...
              >
              <span v-else class="controller-name">
                {{ controller.name }} - {{ controller.cid }}</span
              >
            </div>
        ...
        <div class="info-card">
          ...
          <div v-else v-for="airport in airports" :key="airport.id">
            <h1 class="weather-header text-formatting">
        ...
        <div class="info-card">
          <span class="info-header">Solo Controllers</span>
          <Solo />
        </div>
        <div class="info-card">
...
import Solo from '../components/Home/Solo.vue';
  ...
  setup: () => {
    ...
    const getOnlineControllers = async () => {
      ...
      controllersData.forEach((controller) => {
        ...
        let elapsedMinutes = (
          Math.round(elapsed / msPerMin) % 60
